...
module.exports = {
      ...
      SESSION_ID: process.env.SESSION_ID || "QUEEN-AI;;;PrizeKeeping
", //enter your session id here
      OWNER_NUMBER: process.env.OWNER_NUMBER || "94705281879", //Owner whatsapp number here
      OWNER_NAME: process.env.OWNER_NAME || "Tilan Ransara", //Queen-AI Owner Name here
